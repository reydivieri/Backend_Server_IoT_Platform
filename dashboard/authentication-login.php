...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['login'])) {
        ...
        // Prepare and bind
        $stmt = mysqli_prepare($conn, "SELECT id, password FROM tb_users WHERE username = ?");
        if ($stmt) {
            mysqli_stmt_bind_param($stmt, 's', $username);
            mysqli_stmt_execute($stmt);
            mysqli_stmt_bind_result($stmt, $id, $stored_hashed_password);
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <button onclick="location.href = 'authentication-register.php'" class="btn btn-info" id="to-recover" type="button"><i class="fa fa-user-plus m-r-5"></i> Sign Up?</button>
